...
#ifndef BIOLOID_MOTION_INCLUDE_BIOLOID_BIOLOID_UTILS_HPP_
#define BIOLOID_MOTION_INCLUDE_BIOLOID_BIOLOID_UTILS_HPP_
...
joints_t interpolate(const joints_t angles_a, joints_t angles_b, double coefa);

double getDistance(joints_t angles_a, joints_t angles_b);
...
#endif // BIOLOID_MOTION_INCLUDE_BIOLOID_BIOLOID_UTILS_HPP_
